...
class Configuration():
	def __init__(self):
		...
		self.TEST_FLIP = True
		# self.TEST_CKPT = os.path.join(self.ROOT_DIR,'stage/checkpoints/deeplabv3plus100and200epoch/model_checkpoint_None-v1.ckpt')
		# self.TEST_CKPT = os.path.join(self.ROOT_DIR,'stage/checkpoints/deeplabv3plus100and200epoch/last-v1.ckpt')
		self.TEST_CKPT = os.path.join(self.ROOT_DIR,'stage/checkpoints/deeplabv3plus_cityscapes_bs16_epoch100/model_checkpoint_deeplabv3plus_cityscapes_bs16_epoch100.ckpt')
		self.TEST_GPUS = 1
